  ...
  <div>
    <div class="cpp-table-container" ref="tableWrapper">
        ...
        <el-table-column type="expand" v-if="expand">
          <template slot-scope="props">
            <div class="expand-container">
              <div v-for="(item, index) in columns" class="expand-columns"
                   v-if="hideLevel.indexOf(newPropToLabel.length-index)>-1">
      ...
      <div class="cpp-pagination">
        <span class="total-page" v-if="totalSize">共{{Math.ceil(totalSize / pageSize)}}页</span>
        <el-pagination
